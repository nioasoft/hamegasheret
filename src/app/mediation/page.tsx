...
export const metadata: Metadata = {
  title: "גישור גירושין באר שבע - המגשרת עו״ד זהבית דבי | גישור מקצועי + שלום בית",
  description: "גישור גירושין מקצועי בבאר שבע עם המגשרת עו״ד זהבית דבי - ניסיון של 15+ שנים. חיסכון של 80% בעלויות, תהליך מהיר וממוקד בטובת הילדים. כולל גישור שלום בית והצלת נישואים. ייעוץ ראשוני חינם!",
  ...
  openGraph: {
    ...
    description: "גישור גירושין ושלום בית מקצועי עם ניסיון של 15+ שנים. עו״ד זהבית דבי המגשרת מסייעת להציל נישואים ולהגיע להסכמים מוסכמים ללא מלחמות.",
  ...
  twitter: {
    ...
    description: "גישור גירושין ושלום בית מקצועי ומנוסה - הצלת נישואים, פתרון משברים זוגיים ומשמורת ילדים",
    ...
    <>
      ...
      <main id="main-content">
        <Hero
          ...
          description="עו״ד זהבית דבי, מומחית בגישור גירושין עם ניסיון של 15+ שנים. הגישה הייחודית שלנו מאפשרת לבני זוג להגיע להסכמים מוסכמים תוך שמירה על כבוד הדדי ויחסים טובים."
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                          ...
                          <div className="space-y-4 text-beige-700">
                            ...
                            <p>
                              המוניטין המקצועי שלה והתוצאות מדברות בעד עצמן - ניסיון של 15+ שנים בהגעה להסכמים.
                            </p>
                            <p>
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-lg">
                          ...
                          <ul className="space-y-3">
                            <li className="flex items-center">
                              ...
                              <span>ניסיון רב בהגעה להסכמים</span>
                            </li>
                            <li className="flex items-center">
                              <Check className="text-beige-700 ml-2 h-4 w-4 flex-shrink-0" />
