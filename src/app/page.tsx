...
export const metadata: Metadata = {
  title: "המגשרת באר שבע - עו״ד זהבית דבי | גישור גירושין מקצועי בדרום",
  description: "המגשרת עו״ד זהבית דבי - המובילה בגישור גירושין באר שבע והדרום עם ניסיון של 15+ שנים. גישור מקצועי לגירושין, משמורת ילדים, מזונות ודיני משפחה. ייעוץ ראשוני חינם! חיסכון של 80% בעלויות.",
  ...
  openGraph: {
    title: "המגשרת באר שבע - עו״ד זהבית דבי | גישור גירושין מקצועי",
    description: "המגשרת עו״ד זהבית דבי - המובילה בגישור גירושין באר שבע והדרום. ניסיון של 15+ שנים בהגעה להסכמים, חיסכון של 80% בעלויות. גישור מקצועי לגירושין, משמורת ילדים ומזונות.",
  ...
  twitter: {
    ...
    description: "המגשרת באר שבע - גישור גירושין מקצועי ומנוסה, חיסכון של 80% בעלויות. ייעוץ ראשוני חינם!",
    ...
    <>
      ...
      <main id="main-content">
        <Hero
          ...
          description="המגשרת הבכירה בבאר שבע והדרום, עם ניסיון של 15+ שנים בהגעה להסכמים. מתמחה בתהליך גישור מקצועי ורגיש שמביא לתוצאות מעולות ללא קרבות משפטיים."
