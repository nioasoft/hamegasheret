...
const testimonials = [
  {
    quote: "המגשרת עו״ד זהבית דבי הציגה לנו פתרון שלא חשבנו עליו - משמורת משותפת שמתאימה לכולם. הילדים שלנו זוכים לשני הורים מעורבים.",
    author: "מ.ר.",
    role: "הורה מרוצה"
  },
  {
    quote: "בזכות המגשרת עו״ד זהבית דבי הגענו להסכם משמורת שמתחשב בצרכים של הילדים ובלוח הזמנים של העבודה שלנו. פתרון יצירתי ומעשי.",
    author: "ד.כ.",
    role: "הורה מרוצה"
  }
];
...
const faqs = [
  {
    ...
    answer: "משמורת משותפת פירושה ששני ההורים חולקים באחריות על הילדים ומקבלים החלטות יחד. זה לא אומר בהכרח חלוקה של 50%-50% בזמן, אלא שיתוף של אחריות הורית. המגשרת עו״ד זהבית דבי עוזרת למצוא את החלוקה המתאימה לכל משפחה."
  },
  {
    question: "מתי כדאי לבחור במשמורת יחידה?",
    answer: "משמורת יחידה מתאימה כאשר יש פער גדול ביכולות ההוריות, כאשר יש אלימות או זניחה, או כאשר ההורים גרים רחוק מאוד זה מזה. המגשרת עו״ד זהבית דבי בוחנת כל מקרה לגופו ומציעה את הפתרון הטוב ביותר לטובת הילדים."
  },
  {
    question: "איך המשמורת משפיעה על מזונות ילדים?",
    answer: "המשמורת משפיעה על חישוב המזונות. במשמורת משותפת, העלויות מתחלקות יותר בין ההורים. במשמורת יחידה, ההורה שאינו משמורן בדרך כלל משלם מזונות. המגשרת עו״ד זהבית דבי עוזרת לחשב את המזונות בצורה הוגנת ומדויקת."
  },
  {
    question: "מה קורה אם רוצים לשנות הסכם משמורת קיים?",
    answer: "אפשר לשנות הסכם משמורת אם השתנו הנסיבות משמעותית או אם ההסכם הקיים לא עובד. המגשרת עו״ד זהבית דבי עוזרת להגיע להסכמה על שינויים הדרושים ולהגיש לבית המשפט לאישור."
  },
  {
    question: "איך מכינים ילדים לגירושין ולשינוי במשמורת?",
    answer: "חשוב לדבר עם הילדים בכנות המתאימה לגילם, להבטיח להם שהם לא אשמים, ולהסביר שההורים ממשיכים לאהוב אותם. המגשרת עו״ד זהבית דבי מנחה הורים כיצד לתקשר עם הילדים ובמידת הצורך ממליצה על ליווי מקצועי."
  },
  {
    question: "כמה זמן לוקח להגיע להסכם משמורת?",
    answer: "תהליך גישור משמורת לוקח בדרך כלל 3-6 חודשים, תלוי במורכבות המקרה ובמידת השיתוף פעולה בין ההורים. המגשרת עו״ד זהבית דבי שואפת לתהליך מהיר ויעיל תוך התחשבות בצרכי כל המעורבים."
  }
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        {/* המגשרת עו״ד זהבית דבי - המומחיות */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-beige-900 mb-4">
                  המגשרת עו״ד זהבית דבי - מומחית במשמורת ילדים
                </h2>
                <p className="text-xl text-beige-600">
                  {"כל ילד זוכה לשני הורים"} - זהו העיקרון המנחה את המגשרת עו״ד זהבית דבי
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  <div className="space-y-4 text-beige-700">
                    <p>
                      המגשרת עו״ד זהבית דבי מאמינה שגירושין לא צריכים להרוס את הקשר של הילדים עם ההורים.
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-beige-600">
                המגשרת עו״ד זהבית דבי עוזרת למצוא את הפתרון הטוב ביותר לכל משפחה
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-beige-600">
                  המגשרת עו״ד זהבית דבי מעודכנת בכל השינויים החדשים בחקיקה
                </p>
              </div>
              ...
              <div className="mt-8 p-6 bg-beige-100 rounded-lg">
                ...
                <p className="text-beige-700">
                  ...
                  המגשרת עו״ד זהבית דבי מנצלת את החידושים החוקיים כדי למצוא פתרונות מתקדמים יותר
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-beige-600">
                עצות מעשיות מהמגשרת עו״ד זהבית דבי לניהול הוריות אחרי גירושין
              </p>
            </div>
            ...
            <div className="mt-12 text-center">
              <div className="bg-beige-100 p-6 rounded-lg">
                ...
                <p className="text-beige-700">
                  המגשרת עו״ד זהבית דבי מספקת ליווי מתמשך גם אחרי חתימת ההסכם,
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-beige-600">
                  התשובות לכל השאלות החשובות מהמגשרת עו״ד זהבית דבי
                </p>
              </div>
        ...
        <section className="py-12 bg-beige-900 text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              המגשרת עו״ד זהבית דבי כאן לעזור לכם
            </p>
