              ...
              <Card key={article.title} className="hover:shadow-xl transition-all duration-300 overflow-hidden group">
                <CardHeader className="pb-3">
                  ...
                  <CardTitle className="text-xl leading-tight group-hover:text-blue-600 transition-colors">
                    <Link href={`/articles/${article.slug}`} className="hover:text-slate-600 transition-colors">
                      {article.title}
                    </Link>
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <Link href={`/articles/${article.slug}`}>
                    <Button variant="link" className="px-0 text-slate-600 hover:text-slate-700">
                      קראו עוד ←
                    </Button>
                  </Link>
                </CardContent>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-slate-800 mb-2">{articles.length}</div>
              <div className="text-gray-600">מאמרים מקצועיים</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-slate-800 mb-2">{categories.length}</div>
            ...
            <div>
              ...
              <div className="text-gray-600">הצלחה בגישור</div>
            </div>
          </div>
        </div>
      </section>
