...
const caseStudies = [
  ...
  },
  {
    ...
    intervention: {
      description: "המגשרת זהבית דבי הביאה יועץ מומחה לצרכים מיוחדים והתמקדה ביצירת הסדר שישמור על יציבות עבור איתי תוך מתן מקום משמעותי לשני ההורים.",
      methods: [
    ...
    outcome: {
      ...
      clientQuote: "המגשרת זהבית דבי הבינה שכאן צריך לחשוב מחוץ לקופסה. היא עזרה לנו לשים את איתי במרכז ולמצוא דרך שכולם מרוויחים, במיוחד הוא."
    }
  },
  {
    id: 5,
    ...
    intervention: {
      description: "המגשרת זהבית דבי, בעלת הבנה עמוקה בדיני משפחה דתיים, עבדה בתיאום עם רבני הקהילה ויצרה פתרון שמכבד את ההלכה ואת הקהילה.",
      methods: [
    ...
    outcome: {
      ...
      clientQuote: "זהבית דבי הוכיחה שאפשר לעשות גישור גם בקהילה הדתית. היא כיבדה את הערכים שלנו ועזרה לנו לעבור את זה בדרך של כבוד ושלום."
    }
  },
  {
    id: 6,
    ...
    intervention: {
      description: "המגשרת זהבית דבי הביאה מעריך שווי מומחה לסטארטאפים ועזרה לזוג למצוא מנגנון חלוקה שמתחשב בעתיד הלא ידוע.",
      methods: [
        "הערכת שווי מקצועית",
    ...
    outcome: {
      ...
      clientQuote: "המגשרת זהבית דבי הבינה את המורכבות של חלוקת נכס עתידי. הפתרון שהיא עזרה לנו למצוא היה גאוני ואפשר לנו להמשיך להצליח גם אחרי הגירושין."
    }
  }
];
