...
export const metadata: Metadata = {
  title: "סיפורי גישור - המגשרת עו״ד זהבית דבי",
  description: "סיפורי גישור אמיתיים של המגשרת עו״ד זהבית דבי. גישור מוצלח בגירושין, משמורת ילדים ורכוש. ניסיון רב בפתרון סכסוכים. כך המגשרת פותרת בעיות קשות ומורכבות בגירושין.",
  keywords: "סיפורי גישור, המגשרת עו״ד זהבית דבי, גישור מוצלח, פתרון סכסוכים, גירושין בלי מלחמה, המגשרת באר שבע, גישור משמורת, חלוקת רכוש",
  openGraph: {
    title: "סיפורי גישור - המגשרת עו״ד זהבית דבי",
  ...
  return (
    <>
      <main id="main-content">
        <Hero
          title="סיפורי גישור של המגשרת"
          subtitle="סיפורי גישור אמיתיים"
