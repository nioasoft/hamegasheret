...
export const metadata: Metadata = {
  ...
  description: "מזונות ילדים עם המגשרת זהבית דבי - הערכת חישוב מזונות המותאם לתא המשפחתי ובהתאם לפסיקה הרווחת, הסכמי מזונות הוגנים, גישור מזונות וחיסכון של 75% בעלויות משפט.",
