...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://hamegasheret.co.il/child-support",
    siteName: "המגשרת - עו״ד זהבית דבי",
    locale: "he_IL",
    type: "website",
    images: [
      {
        url: "/og-image-child-support.jpg",
        width: 1200,
        height: 630,
        alt: "מזונות ילדים - המגשרת עו״ד זהבית דבי",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "מזונות ילדים - המגשרת עו״ד זהבית דבי",
    description: "חישוב מזונות מקצועי והסכמי מזונות הוגנים - חיסכון של 75% בעלויות משפט",
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-gradient-to-r from-beige-50 to-beige-200 p-8 rounded-lg">
              <h3 className="text-2xl font-bold text-center mb-6">ניסיון מוכח עם המגשרת עו״ד זהבית דבי</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-3xl font-bold text-beige-800 mb-2">15+</div>
                  <p className="text-beige-700">שנות ניסיון בגישור מזונות</p>
                </div>
                <div>
