          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <h3 className="text-2xl font-bold text-beige-900 md:col-span-2 text-center mb-8">
                  הערכים שלנו
                </h3>
                {values.map((value, index) => (
                  <Card key={index}>
                    ...
                    <CardContent>
                      <p className="text-beige-600">{value.description}</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
              {testimonials.map((testimonial, index) => (
                <Card key={index} className="h-full flex flex-col bg-white border border-beige-200 shadow-md">
                  <CardContent className="p-5 flex-1 flex flex-col">
                    <div className="text-center h-full flex flex-col">
                      <p className="text-beige-700 mb-4 italic text-base leading-7 flex-1">
                        {`"${testimonial.quote}"`}
                      </p>
                      <div className="border-t pt-3 mt-auto">
                        <div className="font-semibold text-beige-900 text-base">
                          {testimonial.author}
                        </div>
