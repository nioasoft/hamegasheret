...
const teamMembers = [
  {
    ...
    description: '"עורכת דין מובילה בתחום דיני המשפחה עם התמחות מיוחדת בגישור גירושין. בעלת ניסיון של למעלה מ-15 שנים ומוניטין של \'קוסמת בגישור\' בקרב דייני בתי הדין הרבניים."',
    achievements: [
      ...
      <main>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                מה אומרים עלינו דיינים בבתי הדין הרבניים
              </h2>
              <p className="text-xl text-gray-600">
