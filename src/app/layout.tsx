...
export const metadata: Metadata = {
  ...
  description: "המגשרת זהבית דבי עם 85% הצלחה. המגשרת המובילה באר שבע ותל אביב. גישור מקצועי לגירושין, משמורת ילדים ודיני משפחה.",
  ...
  openGraph: {
    ...
    description: "המגשרת זהבית דבי עם 85% הצלחה. המגשרת המובילה באר שבע ותל אביב.",
    type: "website",
    locale: "he_IL",
